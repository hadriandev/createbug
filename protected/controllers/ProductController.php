	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','ajaxcomplete'),
				'users'=>array('*'),
			),
...
//1st method using query:: Abhinav Srivastav
//             $res =array();
//                if (isset($_GET['term'])) {
//                    $qtxt ="SELECT name FROM {{product}} WHERE name LIKE :name";
...
//                Yii::app()->end();
//2nd method using model:: Abhinav Srivastav     
//              $searchCriteria = new stdClass();
//            $pages = new CPagination();
//            $pages->pageSize = Yii::app()->params['firmPerPage'];
//            $searchCriteria->select = 'name';
//            $searchCriteria->filters = array('name' => $name);
...
//            $resArray = Yii::App()->search->searchRaw($searchCriteria); // array result
                ...
                if($request!=''){
                    $model=  Product::model()->findAll(array("condition"=>"name like '$request%'"));
                    $data=array();
