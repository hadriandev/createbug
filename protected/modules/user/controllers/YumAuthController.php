...
class YumAuthController extends YumController {
    ...
    public function loginByFacebook() {
        ...
        if(Yii::app()->session['fb_state'] !== $_REQUEST['state'])
            return false;
        ...
        if ($fb_uid) {
            ...
            try {
                ...
                if ($user === null && $profile === null) {
                    // New account
                    $user = new YumUser;
                    $user->username = 'fb_' . YumRegistrationForm::genRandomString(3);
                    $user->password = YumRegistrationForm::genRandomString(6);
                    ...
                    if ($user->save(false)) {
                        ...
                        $profile->firstname = $fb_user['first_name'];
                        $profile->lastname = $fb_user['last_name'];
                        $profile->save(false);
                    }
                } else {
